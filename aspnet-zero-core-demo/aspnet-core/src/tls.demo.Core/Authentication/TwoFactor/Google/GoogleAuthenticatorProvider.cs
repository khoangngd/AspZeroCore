...
namespace tls.demo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : demoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("tls.demo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
