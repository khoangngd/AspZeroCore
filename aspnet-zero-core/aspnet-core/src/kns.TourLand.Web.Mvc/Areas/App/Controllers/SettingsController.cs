...
using kns.TourLand.Configuration.Tenants;
using kns.TourLand.MultiTenancy;
using kns.TourLand.Timing;
using kns.TourLand.Timing.Dto;
using kns.TourLand.Web.Areas.App.Models.Settings;
...
namespace kns.TourLand.Web.Areas.App.Controllers
{
    ...
    public class SettingsController : TourLandControllerBase
    {
