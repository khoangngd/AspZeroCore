...
using kns.TourLand.Authorization.Ldap;
...
using kns.TourLand.DashboardCustomization.Definitions;
using kns.TourLand.Debugging;
using kns.TourLand.DynamicEntityProperties;
using kns.TourLand.Features;
using kns.TourLand.Friendships;
using kns.TourLand.Friendships.Cache;
using kns.TourLand.Localization;
using kns.TourLand.MultiTenancy;
using kns.TourLand.Net.Emailing;
using kns.TourLand.Notifications;
using kns.TourLand.WebHooks;
using Newtonsoft.Json;

namespace kns.TourLand
{
    [DependsOn(
        typeof(TourLandCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class TourLandCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            TourLandLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = TourLandConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, TourLandMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<TourLandSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TourLandCoreModule).GetAssembly());
        }
