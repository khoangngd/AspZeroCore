...
using tls.demo.MultiTenancy.HostDashboard;
...
namespace tls.demo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(demoDbContext context, SubscriptionPayment subscriptionPayment)
        {
