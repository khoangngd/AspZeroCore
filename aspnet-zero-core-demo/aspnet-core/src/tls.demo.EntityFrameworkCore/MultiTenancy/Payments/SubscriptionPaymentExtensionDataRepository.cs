...
using tls.demo.EntityFrameworkCore.Repositories;

namespace tls.demo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : demoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<demoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
