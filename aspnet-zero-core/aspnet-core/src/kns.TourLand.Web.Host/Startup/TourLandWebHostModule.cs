...
using kns.TourLand.Web.Startup.ExternalLoginInfoProviders;
...
namespace kns.TourLand.Web.Startup
{
    ...
    public class TourLandWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public TourLandWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TourLandWebHostModule).GetAssembly());
        }
