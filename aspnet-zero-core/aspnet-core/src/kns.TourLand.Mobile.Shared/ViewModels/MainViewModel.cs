...
using kns.TourLand.Services.Navigation;
...
using kns.TourLand.Controls;
using kns.TourLand.Dto;
using kns.TourLand.Extensions;
using kns.TourLand.Localization;
using kns.TourLand.UI;
using kns.TourLand.UI.Assets;
using kns.TourLand.Views;
using DependencyResolver = kns.TourLand.Core.Dependency.DependencyResolver;
...
namespace kns.TourLand.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "TourLand";
