...
namespace kns.TourLand.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : TourLandAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<TourLandDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{TourLandConsts.ConnectionStringName}", constring);
        }
