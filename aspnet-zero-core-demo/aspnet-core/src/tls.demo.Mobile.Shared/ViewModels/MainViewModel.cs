...
using tls.demo.ApiClient;
using tls.demo.Controls;
using tls.demo.Dto;
using tls.demo.Extensions;
using tls.demo.Localization;
using tls.demo.UI;
using tls.demo.UI.Assets;
using tls.demo.Views;
using DependencyResolver = tls.demo.Core.Dependency.DependencyResolver;
...
namespace tls.demo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "demo";
