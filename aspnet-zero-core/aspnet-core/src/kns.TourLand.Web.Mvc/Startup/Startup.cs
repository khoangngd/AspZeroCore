...
using kns.TourLand.Identity;
using kns.TourLand.Schemas;
using kns.TourLand.Web.Chat.SignalR;
using kns.TourLand.Web.Common;
using kns.TourLand.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using kns.TourLand.Web.IdentityServer;
using kns.TourLand.Web.Swagger;
using Stripe;
...
using kns.TourLand.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using SecurityStampValidatorCallback = kns.TourLand.Identity.SecurityStampValidatorCallback;

namespace kns.TourLand.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<TourLandWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "TourLand API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("kns.TourLand.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "TourLand API", Version = "v1"});
                ...
                var applicationXml = $"kns.TourLand.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"kns.TourLand.Web.Core.xml";
