...
{
    public class TourLandDbContext : AbpZeroDbContext<Tenant, Role, User, TourLandDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public TourLandDbContext(DbContextOptions<TourLandDbContext> options)
            : base(options)
        {
