...
namespace kns.TourLand.Web.Authentication.JwtBearer
{
    public class TourLandJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public TourLandJwtSecurityTokenHandler()
        {
