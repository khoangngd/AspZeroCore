...
{
    public class SessionAppService : TourLandAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = TourLandConsts.Currency,
                        CurrencySign = TourLandConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = TourLandConsts.AllowTenantsToChangeEmailSettings,
