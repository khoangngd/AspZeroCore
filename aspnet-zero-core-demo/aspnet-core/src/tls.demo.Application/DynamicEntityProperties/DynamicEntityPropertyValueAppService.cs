...
using tls.demo.DynamicEntityPropertyValues.Dto;

namespace tls.demo.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : demoAppServiceBase, IDynamicEntityPropertyValueAppService
    {
