...
using tls.demo.Core.Base;
using tls.demo.Core.Extensions;
using tls.demo.Dto;
using tls.demo.Types;

namespace tls.demo.Queries
{
    public class OrganizationUnitQuery : demoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
