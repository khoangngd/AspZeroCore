...
using kns.TourLand.MultiTenancy.Demo;
...
namespace kns.TourLand.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(TourLandConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(TourLandConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
