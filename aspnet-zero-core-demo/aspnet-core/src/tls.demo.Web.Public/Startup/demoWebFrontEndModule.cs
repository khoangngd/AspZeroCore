...
namespace tls.demo.Web.Public.Startup
{
    [DependsOn(
    ...
    public class demoWebFrontEndModule : AbpModule
    {
        ...
        public demoWebFrontEndModule(IWebHostEnvironment env, demoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
