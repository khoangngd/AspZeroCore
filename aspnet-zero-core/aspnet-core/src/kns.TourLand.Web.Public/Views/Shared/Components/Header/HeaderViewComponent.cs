...
using kns.TourLand.Web.Public.Startup;
using kns.TourLand.Web.Session;

namespace kns.TourLand.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : TourLandViewComponent
    {
