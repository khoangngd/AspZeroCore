...
namespace kns.TourLand.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : TourLandServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("kns.TourLand", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
