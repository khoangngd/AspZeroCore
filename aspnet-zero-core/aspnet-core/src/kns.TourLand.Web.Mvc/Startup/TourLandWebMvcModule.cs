...
namespace kns.TourLand.Web.Startup
{
    ...
    public class TourLandWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public TourLandWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TourLandWebMvcModule).GetAssembly());
        }
