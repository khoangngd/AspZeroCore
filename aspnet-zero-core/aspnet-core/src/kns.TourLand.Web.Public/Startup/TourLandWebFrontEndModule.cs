...
namespace kns.TourLand.Web.Public.Startup
{
    [DependsOn(
        typeof(TourLandWebCoreModule)
    )]
    public class TourLandWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public TourLandWebFrontEndModule(IWebHostEnvironment env, TourLandEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TourLandWebFrontEndModule).GetAssembly());
        }
    }
}
