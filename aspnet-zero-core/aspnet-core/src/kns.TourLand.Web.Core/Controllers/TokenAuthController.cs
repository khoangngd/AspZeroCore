...
using kns.TourLand.Authentication.TwoFactor.Google;
...
namespace kns.TourLand.Web.Controllers
{
    ...
    public class TokenAuthController : TourLandControllerBase
    {
