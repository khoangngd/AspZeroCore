...
using kns.TourLand.Auditing.Exporting;
...
using EntityHistoryHelper = kns.TourLand.EntityHistory.EntityHistoryHelper;

namespace kns.TourLand.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : TourLandAppServiceBase, IAuditLogAppService
    {
