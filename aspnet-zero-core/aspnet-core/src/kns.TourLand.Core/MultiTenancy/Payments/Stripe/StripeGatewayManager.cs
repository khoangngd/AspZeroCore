...
{
    public class StripeGatewayManager : TourLandServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "TourLand";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + TourLandConsts.Currency;
        }
