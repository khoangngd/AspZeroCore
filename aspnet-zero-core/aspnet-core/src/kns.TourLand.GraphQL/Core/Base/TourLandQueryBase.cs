...
namespace kns.TourLand.Core.Base
{
    public abstract class TourLandQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected TourLandQueryBase(string fieldName,
