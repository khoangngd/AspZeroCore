...
using kns.TourLand.MultiTenancy.HostDashboard;
...
namespace kns.TourLand.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(TourLandDbContext context, SubscriptionPayment subscriptionPayment)
        {
