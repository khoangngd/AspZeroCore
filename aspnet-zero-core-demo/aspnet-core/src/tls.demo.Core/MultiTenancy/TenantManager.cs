...
using tls.demo.MultiTenancy.Demo;
...
namespace tls.demo.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(demoConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
