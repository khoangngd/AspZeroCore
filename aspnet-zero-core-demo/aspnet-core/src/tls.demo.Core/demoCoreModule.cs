...
using tls.demo.Authorization.Ldap;
using tls.demo.Authorization.Roles;
using tls.demo.Authorization.Users;
using tls.demo.Chat;
using tls.demo.Configuration;
using tls.demo.DashboardCustomization.Definitions;
using tls.demo.Debugging;
using tls.demo.DynamicEntityProperties;
using tls.demo.Features;
using tls.demo.Friendships;
using tls.demo.Friendships.Cache;
using tls.demo.Localization;
using tls.demo.MultiTenancy;
using tls.demo.Net.Emailing;
using tls.demo.Notifications;
using tls.demo.WebHooks;
using Newtonsoft.Json;

namespace tls.demo
{
    [DependsOn(
        typeof(demoCoreSharedModule),
    ...
    public class demoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, demoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
