...
using kns.TourLand.DemoUiComponents.Dto;

namespace kns.TourLand.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : TourLandAppServiceBase, IDemoUiComponentsAppService
    {
