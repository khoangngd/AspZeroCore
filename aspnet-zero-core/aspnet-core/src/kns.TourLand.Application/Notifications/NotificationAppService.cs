...
using Abp.UI;
using kns.TourLand.Notifications.Dto;

namespace kns.TourLand.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : TourLandAppServiceBase, INotificationAppService
    {
