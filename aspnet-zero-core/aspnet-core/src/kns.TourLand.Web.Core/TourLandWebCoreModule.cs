...
using kns.TourLand.Authentication.TwoFactor;
using kns.TourLand.Chat;
using kns.TourLand.Configuration;
using kns.TourLand.EntityFrameworkCore;
using kns.TourLand.Startup;
using kns.TourLand.Web.Authentication.JwtBearer;
using kns.TourLand.Web.Authentication.TwoFactor;
using kns.TourLand.Web.Chat.SignalR;
using kns.TourLand.Web.Common;
using kns.TourLand.Web.Configuration;
using kns.TourLand.Web.DashboardCustomization;

namespace kns.TourLand.Web
{
    [DependsOn(
        typeof(TourLandApplicationModule),
        typeof(TourLandEntityFrameworkCoreModule),
    ...
    public class TourLandWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public TourLandWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(TourLandApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TourLandWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(TourLandWebCoreModule).Assembly);
        }
