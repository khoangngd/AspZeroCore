...
$webMvcFolder = Join-Path $slnFolder "src/kns.TourLand.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/kns.TourLand.Web.Public"
...
dotnet restore kns.TourLand.Web.sln
