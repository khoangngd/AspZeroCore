...
using kns.TourLand.Core.Base;
using kns.TourLand.Core.Extensions;
using kns.TourLand.Dto;
using kns.TourLand.Types;

namespace kns.TourLand.Queries
{
    public class OrganizationUnitQuery : TourLandQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
