...
using tls.demo.DashboardCustomization.Dto;
using tls.demo.Web.Areas.App.Models.CustomizableDashboard;
...
{
    public abstract class CustomizableDashboardControllerBase : demoControllerBase
    {
        ...
        protected async Task<ActionResult> GetView(string dashboardName)
        {
            var dashboardDefinition = DashboardCustomizationAppService.GetDashboardDefinition(
                ...
                {
                    DashboardName = dashboardName,
                    Application = demoDashboardCustomizationConsts.Applications.Mvc
                }
            );
